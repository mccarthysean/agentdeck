...
echo ""
echo -e "  ${BOLD}agentdeck${RESET}"
echo ""
echo -e "  ${DIM}That's it. Server starts, session created, QR code shown.${RESET}"
echo ""
echo -e "  ${DIM}Optional — enable phone notifications:${RESET}"
echo -e "  ${BOLD}agentdeck setup${RESET}  ${DIM}# configure Claude Code hooks + ntfy${RESET}"
echo -e "  ${DIM}Install the ntfy app and subscribe to the topic shown.${RESET}"
echo -e "  ${DIM}https://ntfy.sh${RESET}"
echo ""
