...
echo ""
echo -e "  ${DIM}Or with Claude Code hooks + phone notifications:${RESET}"
echo -e "  ${BOLD}npx agentdeck setup${RESET}  ${DIM}# configure hooks, auto-generate ntfy topic${RESET}"
echo -e "  ${BOLD}npx agentdeck${RESET}        ${DIM}# start server${RESET}"
echo ""
echo -e "  ${DIM}Install the ntfy app and subscribe to the topic shown during setup.${RESET}"
