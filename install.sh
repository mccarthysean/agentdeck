...
echo -e "  ${BOLD}npx agentdeck setup --ntfy-topic MY-SECRET-TOPIC${RESET}  ${DIM}# hooks + ntfy${RESET}"
echo -e "  ${BOLD}npx agentdeck${RESET}                                     ${DIM}# start server${RESET}"
echo ""
echo -e "  ${DIM}Install the ntfy app on your phone and subscribe to the same topic.${RESET}"
